...
public class AssignmentService {
	...
	public Assignment updateAssignment(@PathVariable("assignmentId") int assignmentId, @RequestBody Assignment assignment) {
		...
		if(optionalAssignment.isPresent()) {
			Assignment updateAssignment = optionalAssignment.get();
			updateAssignment.setDescription(assignment.getDescription());
			updateAssignment.setPoints(assignment.getPoints());
			updateAssignment.setTitle(assignment.getTitle());
